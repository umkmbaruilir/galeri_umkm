...
export default function Header() {
  ...
  return (
    <header className="h-16 bg-white dark:bg-coreui-darkCard border-b border-gray-200 dark:border-gray-800 px-6 flex items-center justify-between shadow-sm z-10 sticky top-0">
      <div className="flex items-center gap-4">
        ...
        <div className="hidden md:flex text-sm text-gray-500 dark:text-gray-400">
          Admin / <span className="text-gray-900 dark:text-white ml-1 font-medium">Dashboard</span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 cursor-pointer bg-gray-50 dark:bg-gray-800 py-1.5 px-3 rounded-full border border-gray-200 dark:border-gray-700">
          ...
          <span className="text-sm font-medium hidden sm:block dark:text-white">Admin Baru Ilir</span>
        </div>
      </div>
    </header>
  );
